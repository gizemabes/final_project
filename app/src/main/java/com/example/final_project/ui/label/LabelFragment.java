package com.example.final_project.ui.label;
...
import com.example.final_project.databinding.FragmentLabelBinding;
...
public class LabelFragment extends Fragment {
    ...
    private FragmentLabelBinding fragmentLabelBinding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        fragmentLabelBinding = FragmentLabelBinding.inflate(inflater,container,false);
        View root = fragmentLabelBinding.getRoot();


        LinearLayout linearLayout = fragmentLabelBinding.linearLayout;
        ...
        Button added = fragmentLabelBinding.addBtn;
        added.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText labeltext = fragmentLabelBinding.label;
